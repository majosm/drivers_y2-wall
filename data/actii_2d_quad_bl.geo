...
// these are tuned to make the boundary layer meshes connect with the ends
num_seg_conn = 10;
num_seg_conn_cav = 6;
corner_ball = 2;
If(scale_fac_bl == 2)
...
//Bottom Lines
l_nozzle_bottom = l++;
Spline(l_nozzle_bottom) = {p_nozzle_bottom_start:p_nozzle_bottom_end};

//Inlet
//top boundary layer on inlet
p_inlet_bl_bottom = p++;
p_inlet_bl_top = p++;
Point(p_inlet_bl_top) = {0.21, (0.0270645-bl_thickness),0.0,basesize};
//bottom boundary layer on inlet
Point(p_inlet_bl_bottom) = {0.21, (-0.0270645+bl_thickness),0.0,basesize};

l_inlet = l++;
l_inlet_bl_bottom = l++;
l_inlet_bl_top = l++;
Line(l_inlet) = {p_inlet_bl_bottom, p_inlet_bl_top};  //goes counter-clockwise
Line(l_inlet_bl_bottom) = {p_nozzle_bottom_start, p_inlet_bl_bottom};  //goes counter-clockwise
Line(l_inlet_bl_top) = {p_inlet_bl_top, p_nozzle_top_start};  //goes counter-clockwise
...
Point(p_cavity_rear_bottom_bl) = {x_cavity_rl+bl_thickness,y_cavity_l+bl_thickness,0.0,basesize};
Point(p_cavity_rear_bottom_inner_bl) = {x_cavity_rl,y_cavity_l+bl_thickness,0.0,basesize};
...
// injector bl points
p_injector_cavity_lower_bl = p++;
p_injector_cavity_upper_bl = p++;
p_injector_entrance_lower_bl = p++;
p_injector_entrance_upper_bl = p++;
Point(p_injector_cavity_lower_bl) = {x_cavity_rl+inj_h, y_cavity_l+inj_h+bl_thickness_inj, 0., basesize};
Point(p_injector_entrance_lower_bl) = {x_cavity_rl+inj_h+inj_l, y_cavity_l+inj_h+bl_thickness_inj, 0., basesize};
Point(p_injector_entrance_upper_bl) = {x_cavity_rl+inj_h+inj_l, y_cavity_l+inj_h+inj_d-bl_thickness_inj, 0., basesize};
Point(p_injector_cavity_upper_bl) = {x_cavity_rl+inj_h+inj_d, y_cavity_l+inj_h+inj_d-bl_thickness_inj, 0., basesize};
...
// outlet bl points
p_outlet_bl_bottom = p++;
p_outlet_bl_top = p++;
Point(p_outlet_bl_top) = {0.65163+0.335,0.01167548819733-bl_thickness,0.0,basesize};
Point(p_outlet_bl_bottom) = {0.65163+0.335,-0.008324-(0.265-0.02)*Sin(2*Pi/180)+bl_thickness,0.0,basesize};

//Outlet
l_outlet = l++;
l_outlet_bl_bottom = l++;
l_outlet_bl_top = l++;
Line(l_outlet) = {p_outlet_bl_bottom,p_outlet_bl_top};
//Line(l_outlet) = {p_outlet_lower,p_outlet_upper};
Line(l_outlet_bl_bottom) = {p_outlet_lower,p_outlet_bl_bottom};
Line(l_outlet_bl_top) = {p_outlet_bl_top, p_outlet_upper};
...
l_cavity_front_wall_bl = l++;
l_cavity_bottom_wall_bl = l++;
l_cavity_rear_bl = l++;

l_cavity_front_bl = l++;
l_cavity_bottom_bl = l++;
Line(l_cavity_front_bl) = {p_cavity_front_lower_bl, p_cavity_front_inner_bl};
Line(l_cavity_bottom_bl) = {p_cavity_front_lower_bl, p_cavity_rear_bottom_inner_bl};

l_cavity_front_upper_bl = l++;
l_cavity_front_lower_bl = l++;
l_cavity_bottom_left_bl = l++;
l_cavity_bottom_right_bl = l++;
l_cavity_rear_bottom_bl = l++;
Line(l_cavity_front_upper_bl) = {p_cavity_front_upper, p_cavity_front_inner_bl};
Line(l_cavity_front_lower_bl) = {p_cavity_front_lower_wall_bl,p_cavity_front_lower_bl};
Line(l_cavity_bottom_left_bl) = {p_cavity_front_bottom_wall_bl, p_cavity_front_lower_bl};
Line(l_cavity_bottom_right_bl) = {p_cavity_rear_lower, p_cavity_rear_bottom_inner_bl};
Line(l_cavity_rear_bottom_bl) = {p_cavity_rear_bottom_inner_bl, p_cavity_rear_bottom_bl};


//p_cavity_rear_bottom_inner_bl = p++;

Line(l_isolator_bottom) = {p_nozzle_bottom_end,p_cavity_front_upper};
Line(l_cavity_front_wall_bl) = {p_cavity_front_lower, p_cavity_front_lower_wall_bl};
Line(l_cavity_front) = {p_cavity_front_lower_wall_bl, p_cavity_front_upper};
Line(l_cavity_bottom_wall_bl) = {p_cavity_front_lower,p_cavity_front_bottom_wall_bl};
Line(l_cavity_bottom) = {p_cavity_front_bottom_wall_bl,p_cavity_rear_lower};
Line(l_cavity_rear_bl) = {p_cavity_rear_lower,p_cavity_rear_bottom_bl};
Line(l_cavity_rear_1) = {p_cavity_rear_bottom_bl,p_injector_cavity_lower};
...
Line(l_combustor_bottom) = {p_expansion_start,p_outlet_lower};
...
l_injector_inlet = l++;
l_injector_inlet_bottom_bl = l++;
l_injector_inlet_top_bl = l++;
Line(l_injector_inlet_bottom_bl) = {p_injector_entrance_lower, p_injector_entrance_lower_bl};
Line(l_injector_inlet) = {p_injector_entrance_lower_bl, p_injector_entrance_upper_bl};
Line(l_injector_inlet_top_bl) = {p_injector_entrance_upper_bl, p_injector_entrance_upper};

l_injector_cavity = l++;
l_injector_cavity_bottom_bl = l++;
l_injector_cavity_top_bl = l++;
Line(l_injector_cavity_bottom_bl) = {p_injector_cavity_lower, p_injector_cavity_lower_bl};
Line(l_injector_cavity) = {p_injector_cavity_lower_bl, p_injector_cavity_upper_bl};
Line(l_injector_cavity_top_bl) = {p_injector_cavity_upper_bl, p_injector_cavity_upper};

//Top wall opposite cavity
p_cavity_front_top = p++;
p_cavity_rear_top = p++;
// Top wall, opposite of cavity
Point(p_cavity_front_top) = {0.65163,0.01167548819733,0.0,basesize};
Point(p_cavity_rear_top) = {0.72163+0.02,0.01167548819733,0.0,basesize};
...
p_cavity_rear_bl_bottom = p++;
p_cavity_rear_bl_top = p++;
Point(p_cavity_front_bl_bottom) = {0.65163,-0.0083245+bl_thickness,0.0,basesize};
Point(p_cavity_rear_bl_bottom) = {0.72163+0.02,-0.0083245+bl_thickness,0.0,basesize};
Point(p_cavity_front_bl_top) = {0.65163,0.01167548819733-bl_thickness,0.0,basesize};
Point(p_cavity_rear_bl_top) = {0.72163+0.02,0.01167548819733-bl_thickness,0.0,basesize};

l_isolator_top = l++;
l_cavity_top = l++;
l_combustor_top = l++;
Line(l_isolator_top) = {p_nozzle_top_end,p_cavity_front_top};
Line(l_cavity_top) = {p_cavity_front_top, p_cavity_rear_top};
Line(l_combustor_top) = {p_cavity_rear_top, p_outlet_upper};

// Internal edges to seperate isolator, cavity, combustor
l_cavity_front_bl_bottom = l++;
l_cavity_front_bl_top = l++;
l_cavity_front_upper = l++;
l_cavity_rear_bl_bottom = l++;
l_cavity_rear_bl_top = l++;
l_cavity_rear = l++;
Line(l_cavity_front_bl_bottom) = {p_cavity_front_upper, p_cavity_front_bl_bottom};
Line(l_cavity_front_bl_top) = {p_cavity_front_bl_top, p_cavity_front_top};
Line(l_cavity_front_upper) = {p_cavity_front_bl_bottom, p_cavity_front_bl_top};
//Line(l_cavity_rear_bl_bottom) = {p_cavity_rear_upper, p_cavity_rear_bl_bottom};
Line(l_cavity_rear_bl_bottom) = {p_expansion_start, p_cavity_rear_bl_bottom};
Line(l_cavity_rear_bl_top) = {p_cavity_rear_bl_top, p_cavity_rear_top};
Line(l_cavity_rear) = {p_cavity_rear_bl_bottom, p_cavity_rear_bl_top};
...
l_nozzle_top,
l_isolator_top,
-l_cavity_front_bl_top,
-l_cavity_front_upper,
-l_cavity_front_bl_bottom,
-l_isolator_bottom,
-l_nozzle_bottom
};
...
l_cavity_front_bl_top,
l_cavity_top,
-l_cavity_rear_bl_top,
-l_cavity_rear,
-l_cavity_rear_bl_bottom,
-l_postcavity_flat_2,
-l_postcavity_flat_1,
-l_cavity_rear_4,
-l_cavity_rear_3,
-l_cavity_rear_2,
-l_injector_cavity_top_bl,
-l_injector_cavity,
-l_injector_cavity_bottom_bl,
-l_cavity_rear_1,
-l_cavity_rear_bottom_bl,
-l_cavity_bottom_bl,
l_cavity_front_bl,
...
// cavity bottom bl
Curve Loop(22) = {
l_cavity_bottom_left_bl,
l_cavity_bottom_bl,
-l_cavity_bottom_right_bl,
-l_cavity_bottom
};
//
// cavity front bl
...
-l_cavity_front_upper_bl,
-l_cavity_front_bl,
-l_cavity_front_lower_bl,
l_cavity_front
};
// cavity front corner bl
Curve Loop(24) = {
l_cavity_front_lower_bl,
-l_cavity_bottom_left_bl,
-l_cavity_bottom_wall_bl,
l_cavity_front_wall_bl
};

// cavity rear corner bl
Curve Loop(25) = {
l_cavity_bottom_right_bl,
l_cavity_rear_bottom_bl,
-l_cavity_rear_bl
...
l_injector_cavity_top_bl,
l_injector_top,
-l_injector_inlet_top_bl,
-l_injector_inlet,
-l_injector_inlet_bottom_bl,
-l_injector_bottom
};
...
Physical Surface('fluid') = {1, 2, 3, 4, 22, 23, 24, 25};
Physical Surface('wall_insert') = {-12};
Physical Surface('wall_surround') = {13};

Physical Curve('inflow') = {
    l_inlet,
    l_inlet_bl_top,
    l_inlet_bl_bottom
};
Physical Curve('outflow') = {
    l_outlet,
    l_outlet_bl_top,
    l_outlet_bl_bottom
};
Physical Curve('injection') = {
    l_injector_inlet,
    l_injector_inlet_top_bl,
    l_injector_inlet_bottom_bl
};
...
Field[30] = Restrict;
Field[30].SurfacesList = {1,2,3,4};
Field[30].InField = 16;

Field[31] = Restrict;
Field[31].SurfacesList = {1,2,3,4};
Field[31].InField = 7;
...
Transfinite Curve {
    ...
    -l_cavity_rear_bl_bottom,
    l_cavity_rear_bl_top
//} = 10*scale_fac_bl Using Progression 0.9;
//} = 10*scale_fac_bl Using Progression 0.95;
//} = 20 Using Progression 0.9;
} = num_seg_conn Using Progression 0.90;
//} = 20;
//
Transfinite Curve {
    -l_cavity_front_wall_bl,
    ...
    -l_cavity_bottom_left_bl,
    -l_cavity_bottom_right_bl
} = num_seg_conn_cav Using Progression 0.90;
//} = num_seg_conn_cav;

Transfinite Curve {
    -l_injector_inlet_bottom_bl,
    l_injector_inlet_top_bl
} = 3*scale_fac Using Progression 0.9;

Transfinite Curve {
} = 70*scale_fac Using Progression 0.99;
//} = 50*scale_fac;
...
Field[20].Size = isosize/boundratio/scale_fac_bl/4;
...
// cavity boundary layer mesh
Field[25] = BoundaryLayer;
Field[25].CurvesList = {
    l_cavity_bottom,
    l_cavity_front
};
Field[25].Size = cavitysize/boundratiocavity/2;
Field[25].SizeFar = bigsize;
Field[25].Thickness = bl_thickness;
...
Field[22].VIn = cavitysize/boundratiocavity/corner_ball;
...
Field[24] = Ball;
Field[24].XCenter = 0.70163+inj_h+inj_d;
Field[24].YCenter = -0.0283245+inj_h+inj_d;
Field[24].Radius = bl_thickness_inj;
Field[24].Thickness = 0.1;
Field[24].VIn = injectorsize/boundratioinjector;
Field[24].VOut = bigsize;

BoundaryLayer Field = {20, 21, 25};

// take the minimum of all defined meshing fields
Field[100] = Min;
//Field[100].FieldsList = {2, 3, 4, 5, 6, 8, 9, 12, 14, 18, 22, 23, 24, 112, 114, 116, 30, 31};
//Field[100].FieldsList = {2, 3, 4, 5, 6, 8, 9, 12, 14, 18, 22, 23, 24, 112, 116, 30, 31};
Field[100].FieldsList = {2, 3, 4, 5, 6, 8, 9, 12, 14, 18, 22, 23, 24, 25, 30, 31};
